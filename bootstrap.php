...
<h2 class="text center mb-4">kenapa harus belanja di Great Bekery</h2>
<div class="accordion" id="accordionExample">
  <div class="accordion-item">
    ...
    Di Great Bakery harga memang bersahabat dengan kantong
    </div
  </div>
  <div class="accordion-item">
    <h2 class="accordion-header">
...
<h2 class="text-center mb-4">produk terlaris</h2>
 <div class="col-lg-6 col-md-6 d-block mx-auto mt-5">

<img src="img/8.jpg"class="img-fluid img-thumbnail">
...
<div class="container-center">
<h2 class="text-center mb-3">produk 
kami</h2>
...
<ul class="list-group">
 ...
 <li class="list-group-item list-group-item d-flex justify-content-between align-items-center">Mixue
<span class="badge bg-primary rounded-pill">14</span>
</li>

  <li class="list-group-item list-group-item list-group-item d-flex justify-content-between align-items-center">Donat<span class="badge bg-primary rounded-pill">14</span> 
</li>
 
 <li class="list-group-item list-group-item list-group-item d-flex justify-content-between align-items-center">Seblak
<span class="badge bg-primary rounded-pill">14</span> </li></li>

  <li class="list-group-item  list-group-item list-group-item d-flex justify-content-between align-items-center">Ayam Geprek  
<span class="badge bg-primary rounded-pill">14</span> 
</li>
...
<div class="col-lg-4 md-4 col-sm-6 mb-3">
...
<p class="card-text">Seblak adalah salah satu makanan khas Sunda tepatnya Bandung yang kini populer di kalangan luas. Makanan yang identik bercita rasa gurih pedas dengan rempah kencur itu kini bisa dengan mudah dicari dan dibuat. Teksturnya yang kenyal dan rasanya yang unik membuat kuliner yang satu ini memiliki banyak penggemar.</p>
<a href="#" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">lihat</a>
<ul class="dropdown-menu dropdown-menu-dark">
<li><a class="dropdown-item" href="#">lihat detail</a></li> 
<li><hr class="dropdown-divider">
...
<div class="col-lg-4 md-4 col-sm-6 mb-3">
  ...
  <p class="card-text">Ayam geprek adalah makanan ayam goreng tepung khas Indonesia yang diulek atau dilumatkan bersama sambal bajak. Sebagian besar sumber menyebut bahwa ayam geprek berasal dari Kota Yogyakarta. Kini, ayam geprek telah menjadi hidangan populer yang dapat ditemukan di hampir semua kota besar di Indonesia.</p>
<a href="#" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">lihat</a>
<ul class="dropdown-menu dropdown-menu-dark">
<li><a class="dropdown-item" href="#">lihat detail</a></li>
<li><hr class="dropdown-divider">
...
<h2 class="text-center mb-5">Customer beruntung minggu ini 
<a tabindex="0" data-bs-trigger="focus" class="btn btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" title="informasi" data-bs-content="Pengundian dilakukan setiap hari jum'at jam 17:00">
  ?
</a>
</h2>
...
<textarea class="form-control" id="exampleFormnControlTextarea1" rows="1"></textarea>
